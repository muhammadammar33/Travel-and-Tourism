...
public class BookingT extends JFrame {
    ...
    BookingT() {
        ...
        Title = new JLabel("Now Choose Your Transportation");
        Title.setFont(new Font("Calibri", Font.BOLD, 42));
        Title.setBounds(80, 0, 620, 80);
        Title.setForeground(Color.MAGENTA);
        p1.add(Title);

        Id = new JLabel("Enter the Id of Transportation:");
        ...
        ViewDest = new JButton("View Transportations");
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand() == "Submit") {
                ...
                dispose();
                new BookingA();
            } else if (e.getActionCommand() == "View Transportations") {
