...
public class BookingTG extends JFrame {
    ...
    BookingTG() {
        ...
        Title = new JLabel("Now Choose Your Tour Guide");
        Title.setFont(new Font("Calibri", Font.BOLD, 42));
        Title.setBounds(80, 0, 620, 80);
        Title.setForeground(Color.MAGENTA);
        p1.add(Title);

        Id = new JLabel("Enter the Id of Tour Guide:");
        ...
        ViewDest = new JButton("View Tour Guides");
    ...
    public class MyActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand() == "Submit") {
                ...
                dispose();
                new BookingT();
            } else if (e.getActionCommand() == "View Tour Guides") {
                new ViewTourGuide();
            }
        }
